...
@Slf4j
@Component
public class ChangeUrlCas1Processor implements ItemProcessor<DocumentProcess, DocumentProcess> {
    @Override
    public DocumentProcess process(DocumentProcess documentProcess) throws Exception {
        try {
            ...
            documentProcess.edited = documentTef.changeUrlCas1(documentProcess.url);
